/* Template Factory - Performance Plumbing & Rooter live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-performance-sanbernardino/';
  var LS_CHANGES = 'tf_performance_change_log_v1';
  var LS_PURCHASED = 'tf_performance_purchased_v1';
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Jeffrey at Performance Plumbing & Rooter. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Jeffrey at Performance Plumbing & Rooter. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Performance Plumbing & Rooter. Hang tight.',
        delay,
        function () {
